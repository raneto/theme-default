...
window.CodeMirror = (function () {
  ...
  function buildLineElement(cm, line, lineNo, dims, reuse) {
    ...
    if (line.bgClass)
      wrap.insertBefore(
        elt("div", null, line.bgClass + " CodeMirror-linebackground"),
        wrap.firstChild,
      );
  ...
  function findCachedMeasurement(cm, line) {
    ...
    for (var i = 0; i < cache.length; ++i) {
      ...
      if (
        ...
        memo.classes ==
          line.textClass + "|" + line.bgClass + "|" + line.wrapClass
      )
        return memo;
    }
  }
  ...
  function measureLineWidth(cm, line) {
    ...
    if (cached)
      return measureChar(cm, line, line.text.length, cached.measure, "right")
        .right;
  ...
  function endOperation(cm) {
    ...
    if (op.updateScrollPos) {
      ...
      if (op.scrollToPos)
        scrollPosIntoView(
          cm,
          clipPos(cm.doc, op.scrollToPos),
          op.scrollToPosMargin,
        );
  ...
  TextMarker.prototype.changed = function () {
    ...
    if (
      pos.from.line >= cm.display.showingFrom &&
    ...
    if (widget) {
      ...
      if (builder.measure) {
        if (size) {
          ...
          var elt = (builder.measure[builder.pos] = zeroWidthElement(
            builder.cm.display.measure,
          ));
...
CodeMirror.defineMode(
  ...
  function (cmCfg, modeCfg) {
    ...
    var htmlMode = CodeMirror.getMode(
      cmCfg,
      htmlFound ? "text/html" : "text/plain",
    );
    var aliases = {
      html: "htmlmixed",
      js: "javascript",
    ...
    function blockNormal(stream, state) {
      ...
      if (state.indentationDiff >= 4) {
        ...
        stream.peek() === "#" ||
        (prevLineHasContent && stream.match(headerRE))
      ) {
        state.header = true;
      } else if (stream.eat(">")) {
        state.indentation++;
        ...
        (a = a.replace(/((^[ \t]*>[ \t]?.+\n(.+\n)*\n*)+)/gm, function (a, b) {
          ...
          return (
            ...
            (c = c.replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (a, b) {
              var c = b;
              return (
                (c = c.replace(/^  /gm, "~0")), (c = c.replace(/~0/g, "")), c
              );
            })),
            A("<blockquote>\n" + c + "\n</blockquote>")
          );
  ...
  $(function () {
    ...
    var converter = new ShowDown.converter(),
      editor = CodeMirror.fromTextArea(
        document.getElementById("entry-markdown"),
        {
          mode: "markdown",
          tabMode: "indent",
          lineWrapping: true,
